...
fun escogeAlgoritmo(secuencia: Array<Number>, algoritmo: String, intentos: Int, algoritmosMap: Map<String, String>,): Array<Double> {
    ...
    /*
        Se ejecuta la funcion que calcula el promedio y desviacion estandar de los tiempos, y que imprime los
        resultados
     */
    imprimeMensajeE(algoritmosMap["$algoritmo"]!!,tiempoEjecucion)
